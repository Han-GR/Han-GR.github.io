...
#### 3. Vinext：让 Next.js 跑在 Workers 上
传统的 Next.js 需要 Node.js 服务端，Workers 基于 V8 引擎，它们不兼容。但 Cloudflare 的 Vinext 项目用 Vite 重新实现了 Next.js 的 App Router 和 React Server Components，让整个框架可以编译成 Workers 可运行的代码。
```bash
